...
@essay.file_assets.attach(@asset)
@essay.file_assets.file_asset.detach -or- @essay.file_assets.detach(@asset)
</pre>
...
<pre>
@essay.file_assets.first.browser_safe? # => returns true or false
</pre>
